...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { address: @college.address, address_2: @college.address_2, description: @college.description, email: @college.email, name: @college.name, phone: @college.phone, state: @college.state } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { address: @college.address, address_2: @college.address_2, description: @college.description, email: @college.email, name: @college.name, phone: @college.phone, state: @college.state } }
