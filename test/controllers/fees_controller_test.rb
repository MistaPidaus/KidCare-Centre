...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { amount: @fee.amount, payment_method: @fee.payment_method, user_id: @fee.user_id } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { amount: @fee.amount, payment_method: @fee.payment_method, user_id: @fee.user_id } }
