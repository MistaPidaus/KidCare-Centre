...
class LeavesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leafe" do
    assert_difference('Leave.count') do
      post leaves_url, params: { leafe: { duration: @leafe.duration, end_date: @leafe.end_date, reason: @leafe.reason, start_date: @leafe.start_date, user_id: @leafe.user_id } }
    end
  ...
  test "should update leafe" do
    patch leafe_url(@leafe), params: { leafe: { duration: @leafe.duration, end_date: @leafe.end_date, reason: @leafe.reason, start_date: @leafe.start_date, user_id: @leafe.user_id } }
